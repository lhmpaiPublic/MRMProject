...
// 
////////////////////////////////////////////////////////////////////////////////
ImageEx::ImageEx(LPCTSTR sResourceType, UINT sResource)
{
	Initialize();
...
// 
////////////////////////////////////////////////////////////////////////////////
bool ImageEx::GetResource(UINT lpName, LPCTSTR lpType, void* pResource, int& nBufSize)
{ 
	HRSRC		hResInfo;
	HANDLE		hRes;
	LPSTR		lpRes	= NULL; 
	...
	hResInfo = FindResource(m_hInst , MAKEINTRESOURCE(lpName), lpType);
	if (hResInfo == NULL) 
	{
...
// 
////////////////////////////////////////////////////////////////////////////////
bool ImageEx::Load(CString sResourceType, UINT sResource)
{
	bool bResult = false;
