...
{
public:
	ImageEx(IN LPCTSTR  sResourceType, UINT  sResource);
...
protected:
	...
	bool GetResource(UINT lpName, LPCTSTR lpType, void* pResource, int& nBufSize);
	bool Load(CString sResourceType, UINT sResource);
