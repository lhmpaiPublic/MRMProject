...
void CPropertyList::setPropKeyMappStringHi(int mappKey, SPrMoTy::MODELTYPE modelType, CString propName)
{
...
bool CPropertyList::getPropKeyMappStringHi(int mappKey, SPrMoTy::MODELTYPE modelType, vector<CString>& strProp)
{
	PropKeyMappString::CPair* pair = itemMappStrHi[modelType].Lookup(mappKey);
	if(pair != NULL)
	{
...
void CPropertyList::setPropKeyMappListIndexHi(int mappKey, SPrMoTy::MODELTYPE modelType, int idx)
{
...
bool CPropertyList::getPropKeyMappListIndexHi(int mappKey, SPrMoTy::MODELTYPE modelType, vector<int>& idxVal)
{
	PropKeyMappListIndex::CPair* pair = itemListIndexHi[modelType].Lookup(mappKey);
	if(pair != NULL)
	{
...
void CPropertyList::hHiPropertyItem(CListCtrl* listCtrl, SPrMoTy::COMBATANT combat, SPrMoTy::PRODUCTTYPE propType, SPrMoTy::COMBATANTCLASS cbtClass)
{
	vector<int> lowKey = keyList[combat][propType].getMappKey(SPrMoTy::MTLOW);
	vector<int> hiKey = keyList[combat][propType].getMappKey(SPrMoTy::MTHI);
...
void CPropertyList::hLowPropertyItem(CListCtrl* listCtrl, SPrMoTy::COMBATANT combat, SPrMoTy::PRODUCTTYPE propType, SPrMoTy::COMBATANTCLASS cbtClass)
{
	vector<int> lowKey = keyList[combat][propType].getMappKey(SPrMoTy::MTLOW);
	vector<int> hiKey = keyList[combat][propType].getMappKey(SPrMoTy::MTHI);
...
void CPropertyList::hLowPropertyIRatio(CListCtrl* listCtrl, SPrMoTy::COMBATANT combat, SPrMoTy::PRODUCTTYPE propType, SPrMoTy::COMBATANTCLASS cbtClass)
{
	vector<int> lowKey = keyList[combat][propType].getMappKey(SPrMoTy::MTLOW);
	vector<int> hiKey = keyList[combat][propType].getMappKey(SPrMoTy::MTHI);
